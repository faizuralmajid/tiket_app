                                  ...
                                  <?php
                                    ...
                                    ?>
                                      <tr class="text-center">
                                          ...
                                          <td style="text-align: left;"><?php echo $u->kategori ?></td>
                                          <td class="text-center">
                                              <button class="btn btn-sm btn-warning btn-edit" data-id='<?php echo $u->id; ?>' data-nama='<?php echo $u->kategori; ?>'>Update</button>
                                              <a href=<?= base_url("admin/delete_parent/" . $u->kategori . "/" . $u->id) ?> class=" btn btn-sm btn-danger">Hapus</a>
                                          </td>
                                      </tr>
                                  <?php
                                        $i++;
                          ...
                          <table id="tble" class="table align-items-center table-flush">
                              <thead class="thead-light">
                                  <tr class="text-center">
                                      <th style="width: 60px;">No</th>
                                      <th scope="col" style="text-align: left;">Menu Parent</th>
                                      <th scope="col" style="text-align: left;">Sub Menu</th>
                                      <th scope="col">Option</th>
                                  </tr>
                              </thead>
                              <tbody>
                                  <?php
                                    ...
                                    ?>
                                      <tr class="text-center">
                                          <td style="width: 60px;"><?php echo $i ?></td>
                                          <td style="text-align: left;"><?php echo $u->kategori ?></td>
                                          <td style="text-align: left;"><?php echo $u->subkategori ?></td>
                                          <td class="text-center">
                                              <button class="btn btn-sm btn-warning btn-edit-sub" data-id='<?php echo $u->id; ?>' data-idsub='<?php echo $u->id_sub; ?>' data-namakat='<?php echo $u->kategori; ?>' data-nama='<?php echo $u->subkategori; ?>'>Update</button>
                                              <a href=<?= base_url("admin/delete_subparent/" . $u->id_sub) ?> class=" btn btn-sm btn-danger">Hapus</a>
                                          </td>
                                      </tr>
                                  <?php
                                        $i++;
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form method="post" action="<?= base_url('admin/create_parent') ?>">
                          <div class="form-group ">
                              <label>Nama Menu</label>
                              <input type="text" class="form-control" name="kategori" placeholder="Masukan Menu Baru">
                          </div>

                          <input type="submit" class="btn btn-success" value="Tambah Menu">
                      </form>
                  </div>
      ...
      <div class="modal" id="update_parentmenu">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <!-- Modal body -->
                  <div class="modal-body">
                      <form method="post" action="<?= base_url('admin/update_parent') ?>">
                          <div class="form-group ">
                              <label>Nama Menu</label>
      ...
      <div class="modal" id="submenu">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                  <div class="modal-header">
                      <h4 class="modal-title">Form Tambah Sub Menu</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>

                  <!-- Modal body -->
                  <div class="modal-body">
                      <form method="post" action="<?= base_url('admin/create_subparent') ?>">
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="kategori">
                                  ...
                                  <?php
                                    foreach ($kategori as $u) {
                                    ?>
                                      <option value="<?php echo $u->id ?>"><?php echo $u->kategori ?></option>
                                  <?php } ?>
                              </select>
                          </div>
                          <div class="form-group ">
                              <label>Nama Sub Menu</label>
                              <input type="text" name="subkategori" required class="form-control" placeholder="Masukan Menu Baru">
                          </div>
                          <input type="submit" class="btn btn-success" value="Tambah Sub Menu">
                      </form>
                  </div>
      ...
      <div class="modal" id="update_submenu">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                  <div class="modal-header">
                      <h4 class="modal-title">Form Update Sub Menu</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>

                  <!-- Modal body -->
                  <div class="modal-body">
                      <form method="post" action="<?= base_url('admin/update_subparent') ?>">
                          <div class="form-group ">
                              <label>Nama Parent Menu</label>
                          ...
                          <div class="form-group">
                              <label class="col-form-label">Ganti Parent Menu:</label>
                              <select class="form-control" name="kategori">
                                  <option>--Pilih Menu</option>
                                  <?php
                                    foreach ($kategori as $u) {
                          ...
                          <div class="form-group " style="display: none;">
                              <label>Nama Menu</label>
                              <input type="text" disabled class="form-control" id="mod_id_sub" name="id_sub" placeholder="Masukan Menu Update">
                          </div>
                          <input type="submit" class="btn btn-success" value="Update Sub Menu">
                      </form>
                  </div>
